...
public class ReservasView extends JFrame {
	...
	public void salvarReserva() {
		...
		Reserva novaRserva = new Reserva(java.sql.Date.valueOf(dataEntrada), java.sql.Date.valueOf(dataSaida), 
			new BigDecimal(txtValor.getText()), txtFormaPagamento.getSelectedItem().toString()); 
		
		controller.inserir(novaRserva);
		
		JOptionPane.showMessageDialog(contentPane, "Registro Salvo, Número Reserva " + novaRserva.getId().toString());
		
		RegistroHospede registroHospede = new RegistroHospede(novaRserva.getId());
